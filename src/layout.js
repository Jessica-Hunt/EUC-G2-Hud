import { ImageContainerProperty, ListContainerProperty, ListItemContainerProperty, TextContainerProperty, } from "@evenrealities/even_hub_sdk";
import { BLANK_TEXT, CAPTURE_CONTENT, CAPTURE_ID, CAPTURE_NAME, COMPACT_FAST_READOUT_CONTAINER, COMPACT_SLOW_TEXT_CONTAINERS, DIAL_HEARTBEAT_CONTAINER, FAST_READOUT_CONTAINER, HUD_HEIGHT, HUD_WIDTH, IMAGE_TILES, SLOW_TEXT_CONTAINERS, TILE_HEIGHT, TILE_WIDTH, } from "./config";
let activeHudLayoutMode = "compact";
export function setHudLayoutMode(mode) {
    activeHudLayoutMode = mode;
}
export function getHudLayoutMode() {
...
export function currentSlowTextContainers() {
    return activeHudLayoutMode === "compact"
...
export function buildHudPageDefinition() {
    ...
    return {
        containerTotalNum: IMAGE_TILES.length
